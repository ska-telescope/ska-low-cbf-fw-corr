...
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_8k
...
# 512 bit wide AXI register slice, 64 bit address, single SLR crossing
create_ip -name axi_register_slice -vendor xilinx.com -library ip -version 2.1 -module_name axi_reg_slice512_SLR1C
set_property -dict [list \
  CONFIG.Component_Name {axi_reg_slice512_SLR1C} \
  ...
  CONFIG.REG_R {15} \
  CONFIG.REG_W {15} \
] [get_ips axi_reg_slice512_SLR1C]
create_ip_run [get_ips axi_reg_slice512_SLR1C]
