# Modified version of create_project.tcl script for the correlator,
# To work with the Alveo V80
# Changes: 
# - Use vivado 2023.2
# - Changed DEVICE to "xcv80*"
# - no board defined for the V80, removed set_property $BOARD
# - Removed timeslave, it doesn't have scripts for Vivado 2023.2 
# - ARGS block design for axi interconnect uses parts that are not valid for the v80; commented out the ARGS block design.
#   (file is $ARGS_PATH/correlator_bd.tcl)
# - vitisAccelCore.tcl replaced with vitisAccelCore_v80.tcl because of obsolete IP
#   (including : ila version 6.2)
#   (          : clock wizard version 6.0)
# - LFAADecode uses a modified version of the args slave for vcstats, since ARGS "RAM" slaves 
#   use block ram IP. Modified version uses xpm memory.
...
source $DESIGN_PATH/src/ip/vitisAccelCore_v80.tcl
...
add_files -fileset sources_1 [glob \
 ...
 $RLIBRARIES_PATH/signalProcessing/LFAADecode100G/src/vhdl/LFAADecode100G_lfaadecode100g_vcstats_ram.vhd \
...
# tcl scripts for ip generation
# Replaced with modified version that doesn't use BRAM IP block.
# source $ARGS_PATH/LFAADecode100G/lfaadecode100g/ip_LFAADecode100G_lfaadecode100g_vcstats_ram.tcl
source $RLIBRARIES_PATH/signalProcessing/LFAADecode100G/src/ip/ip_LFAADecode100G_lfaadecode100g_vcstats_ram.tcl
