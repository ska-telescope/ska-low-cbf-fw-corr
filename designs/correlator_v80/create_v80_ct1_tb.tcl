# Create a project for running the corner turn 1 testbench
# This is for testing corner turn 1 and the filterbanks

set time_raw [clock seconds];
set date_string [clock format $time_raw -format "%y%m%d_%H%M%S"]
set design_name     "v80_ct1_tb_top"
...
create_fileset -simset sim_ct1

set_property SOURCE_SET sources_1 [get_filesets sim_ct1]
...
current_fileset -simset [ get_filesets sim_ct1 ]
...
#set_property used_in_simulation false [get_files  $REPO_BASE/build/v80/v80_top.srcs/sources_1/bd/top/top.bd]
  ...
  set_property top corr_ct1_top [current_fileset]
