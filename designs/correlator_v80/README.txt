...
python3 $SVN/tools/radiohdl/base/vivado_config.py -l correlator_v80 -a
...
python3 $SVN/tools/args/gen_c_config.py -f correlator_v80
...
# For v80 design
export PERSONALITY=correlator_v80
