...
## This script creates a Vivado project for the corner turn 2 testbench for the v80
...
# if [ "$1" = "clean" ]; then
    echo -e "Deleting Build Directory $GITREPO/build/v80_ct2_tb"
    rm -rf $GITREPO/build/v80_ct2_tb
# fi
...
#    vivado -mode batch -source $GITREPO/designs/correlator_v80/create_v80_ct1_tb.tcl -source $GITREPO/common/v80_infra/scripts/build_v80_design.tcl -tclargs $kernel | $COLOUR
    ...
    vivado -mode batch -source $GITREPO/designs/correlator_v80/create_v80_ct2_tb.tcl -tclargs $kernel | $COLOUR
#fi
