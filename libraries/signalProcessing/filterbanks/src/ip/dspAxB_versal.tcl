...
#create_ip -name dsp_macro -vendor xilinx.com -library ip -version 1.0 -module_name DSP_AxB_plus_PCIN
#set_property -dict [list CONFIG.Component_Name {DSP_AxB_plus_PCIN} CONFIG.instruction1 {A*B+PCIN} CONFIG.pipeline_options {Expert}
#CONFIG.areg_4 {false} 
#CONFIG.breg_4 {false} 
#CONFIG.a_width {27} 
...
#CONFIG.pcin_binarywidth {0}] [get_ips DSP_AxB_plus_PCIN]
#create_ip_run [get_ips DSP_AxB_plus_PCIN]

#create_ip -name dsp_macro -vendor xilinx.com -library ip -version 1.0 -module_name DSP_AxB
