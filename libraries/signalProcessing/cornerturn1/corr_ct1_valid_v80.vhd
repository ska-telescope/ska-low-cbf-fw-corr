...
architecture Behavioral of corr_ct1_valid_v80 is
    ...
    signal addra : std_logic_vector(20 downto 0);
    signal dina : std_logic_vector(63 downto 0);
    signal clearPending : std_logic := '0';
    signal clearAddr : std_logic_vector(20 downto 0) := (others => '0');    
    
    signal doutb : std_logic_vector(63 downto 0);
    signal dinb : std_logic_vector(63 downto 0);
    signal web : std_logic_vector(0 downto 0);
    signal addrb : std_logic_vector(20 downto 0);
    ...
    signal set_fifo_dout : std_logic_vector(20 downto 0);
    ...
    signal clear_fifo_dout : std_logic_vector(20 downto 0);
    ...
    signal addrbLowDel1 : std_logic_vector(5 downto 0);
    signal addrbLowDel2_5_3 : std_logic_Vector(2 downto 0);
...
begin
        ...
        if rising_edge(i_clk) then
            ...
            if i_rst = '1' then
                ...
                case setclear_fsm is
                    ...
                    when set_bit =>
                        dina(to_integer(unsigned(addra(5 downto 0)))) <= '1';
                        wea(0) <= '1';
                        setclear_fsm <= idle;
                    ...
                    when clear_bit =>
                        dina(to_integer(unsigned(addra(5 downto 0)))) <= '0';
                        wea(0) <= '1';
                        setclear_fsm <= idle;
            ...
            if setclear_fsm = set_bit and (dina(to_integer(unsigned(addra(5 downto 0)))) = '1') then
            ...
            if rstDel1 = '0' and rstDel2 = '1' then -- falling edge of reset
                ...
                addrb <= std_logic_vector(unsigned(addrb) + 64); -- high order bits of the address for writing 64-bit wide words
                if addrb(20 downto 6) = "101000000000000" then   -- 5 * 4096 = 20480 = 0b0101_0000_0000_0000
                    rstActive <= '0';
                    web(0) <= '0';
                end if;
            else
            ...
            addrbLowDel1 <= addrb(5 downto 0);
            addrbLowDel2_5_3 <= addrbLowDel1(5 downto 3);
            addrbLowDel2_2_0 <= addrbLowDel1(2 downto 0);
            addrbLowDel3_2_0 <= addrbLowDel2_2_0;
            
            readData8 <= doutb((to_integer(unsigned(addrbLowDel2_5_3))*8 + 7) downto (to_integer(unsigned(addrbLowDel2_5_3))*8));
    ...
    generic map (
        ...
        BYTE_WRITE_WIDTH_A => 64,        -- Same width as data width, so single bit write enable.
        ...
        MEMORY_SIZE => 1310720,          -- DECIMAL; total size in bits; 5 * 4096 * 64 = 1310720
        ...
        addra => addra(20 downto 6), -- ADDR_WIDTH_A-bit input: Address for port A write and read operations.
        addrb => addrb(20 downto 6), -- ADDR_WIDTH_B-bit input: Address for port B write and read operations.
