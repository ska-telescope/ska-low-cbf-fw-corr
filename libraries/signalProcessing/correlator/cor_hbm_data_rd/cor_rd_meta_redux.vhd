...
-- 
-- This module assumes a maximum of 2048 stations/baselines.
-- 2 bytes per visibility
--
-- This will use 2 URAMs and pack 16 lines of the matrix upto 2048 wide.
-- URAMs have a natural width of 4K x 72 bits
-- 512W should use 8 URAMs which would give an effectively 64 bytes x 4096 deep
